  ...
  "cj_api" => {
    "links" => {
      ...
      },
      {
        ...
        "promotion-end-date" => "",
        "language" => "",
        "clickUrl" => "https://www.example3.com"
      }
    ]
    }
  }
...
# puts promotion1(hash)
# def promotion1 hash
#   hash.["cj_api"]["links"]["link"].select do |link|  
#     if !link["promotion-end-date"].nil? && !link["promotion-end-date"].empty? && !link["language"].nil? || link["language"].empty?
